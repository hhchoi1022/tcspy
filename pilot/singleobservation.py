...
if __name__ == '__main__':
    ...
    connected_devices = StartUp(unitnum= 4).run()
#%%
...
if __name__ == '__main__': 
    ...
    obs = singleObservation(**devices, observer = observer, unitnum =4)
    ra = '8:00:00'
    dec = '-49:09:04'
    ...
    alt = 40
    az = 270
    #hdu = obs.slew_exposure(target_ra = coordinate_radec.ra.hour, target_dec = coordinate_radec.dec.deg, exptime = 10, counts = 1, filter = 'w425', binning = 2)
    stats = obs.slew_exposure( target_alt = alt, target_az = az, exptime = 10, counts = 1, filter = 'w425', binning = 2)
# %%
