...
if __name__ == '__main__':
    ...
    # Bias
    A.schedule_app(A.run_bias, A.obsnight.sunrise_observation + 35 * u.minute, count = 9, binning = 1, gain = 0, alert_slack = alert_slack)
    ...
    # Dark for exoplanet
    A.schedule_app(A.run_dark, A.obsnight.sunrise_flat + 65 * u.minute, count = 9, exptime = 15, binning = 1, gain = 0, alert_slack = alert_slack)

    # Shutdown
    A.schedule_app(A.run_shutdown, A.obsnight.sunrise_flat + 75 * u.minute, fanoff = True, slew = True, warm = True, alert_slack = alert_slack)
