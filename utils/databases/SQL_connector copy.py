...
class SQL_Connector:
    ...
    def remove_rows(self,
                    ...
                    ids: list or str):
        """
        Remove rows from the specified table based on the provided IDs.
        ...
        ids : list or str
            The IDs of the rows to be removed. Can be a single ID or a list of IDs.
        ...
        sql_command = f"DELETE FROM {tbl_name} WHERE id IN ({id_list})"
        try:
