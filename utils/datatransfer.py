...
if __name__ == '__main__':
    ...
    import time
    A.run(key = '*/image/2024-12-05_gain2750', save_hash = True, tar = True, transfer = True, move_and_clean = False, thread = False)
    time.sleep(600)
    A.run(key = '*/image/2024-12-14_gain2750', save_hash = True, tar = True, transfer = True, move_and_clean = False, thread = False)
    time.sleep(600)
    A.run(key = '*/image/2024-12-15_gain2750', save_hash = True, tar = True, transfer = True, move_and_clean = False, thread = False)
