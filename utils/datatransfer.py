...
if __name__ == '__main__':
    ...
    import time
    A.run(key = '*/image/2025-01-12_gain0', save_hash = True, tar = True, transfer = True, move_and_clean = True, thread = False)
    time.sleep(600)
    A.run(key = '*/image/2025-01-13_gain0', save_hash = True, tar = True, transfer = True, move_and_clean = True, thread = False)
    time.sleep(600)
