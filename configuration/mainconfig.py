...
class mainConfig:
    ...
    def _make_configuration(dict_params : dict,
        ...
        weather_params = dict(WEATHER_HOSTIP = '10.0.101.178',
                              WEATHER_PORTNUM = '11111',
                              WEATHER_DEVICENUM = 0,
                              WEATHER_CHECKTIME = 0.5,
                              WEATHER_CONSTRAINTSFILE = os.path.dirname(__file__)+'/WeatherConstraints.data')
        
        dome_params = dict(DOME_HOSTIP = '10.0.101.178',
                           DOME_PORTNUM = '11111',
                           DOME_DEVICENUM = 0,
                           DOME_CHECKTIME = 0.5)
        safetymonitor_params = dict(SAFEMONITOR_HOSTIP = '10.0.101.178',
        ...
        telescope_params = dict(TELESCOPE_DEVICE = 'PWI4', # or PWI4
                                ...
                                TELESCOPE_PARKALT = 50,
                                TELESCOPE_PARKAZ = 180,
        ...
        general_params = dict(TCSPY_VERSION = 'Version 0.1',
                            TCSPY_NAME = 'TCSpy'
                            )
